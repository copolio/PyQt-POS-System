...
class Ui_Form(QObject):
    def setupUi(self, Form):
        ...
        self.timeLabel.setMinimumSize(QtCore.QSize(200, 50))
        ...
        self.addProductBtn.setMinimumSize(QtCore.QSize(350, 120))
        self.addProductBtn.setMaximumSize(QtCore.QSize(350, 120))
        ...
        self.deleteProductBtn.setMinimumSize(QtCore.QSize(350, 120))
        self.deleteProductBtn.setMaximumSize(QtCore.QSize(350, 120))
        ...
        self.goBackBtn.setMinimumSize(QtCore.QSize(350, 120))
        self.goBackBtn.setMaximumSize(QtCore.QSize(350, 120))
...
class ChangePrice(QMainWindow, Ui_Form):
    ...
    def changePrice(self):
        ...
        productPrice = self.originalPriceBox.text()
        newPrice = self.newPriceBox.text()
        # 입력에 대한 유효성 검사
